...
if parameters.temptrackfile:
    ...
    copyfile(parameters.temptrackfile, os.path.join(current_dir, 'tempoverviewfile.gpx'))
if parameters.tempwaypointfile:
    print("|   tempwaypointfile = %s" % parameters.tempwaypointfile)
    copyfile(parameters.tempwaypointfile, os.path.join(current_dir, 'tempwaypointfile.gpx'))
